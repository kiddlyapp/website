...
export const Heart = ({ width = '16px', height = '14px', fill = '#E92B2B' }: LogoProps) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 16 14" fill={fill} className="inline-block">
            <path
